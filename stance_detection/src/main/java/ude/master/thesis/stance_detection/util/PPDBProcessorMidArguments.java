...
public class PPDBProcessorMidArguments {
	...
	public static void main(String[] args) throws Exception {
		...
		//generateHungarianPPDBFeaturesAndSave(trainingSummIdBoyMap, trainingStances,
			//	ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TRAIN);
		...
		//generateHungarianPPDBFeaturesAndSave(testSummIdBoyMap, testStances,
			//	ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TEST);

		saveHungarianScoreIdxsInFileMap(ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TRAIN,
				ProjectPaths.PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TRAIN);

		saveHungarianScoreIdxsInFileMap(ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TEST,
				ProjectPaths.PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TEST);

		 savePPDBFeaturesAsHashFiles(ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TRAIN,
				 ProjectPaths.PPDB_HUNG_FEATURE_PARTS_ARG_TRAIN);
		 savePPDBFeaturesAsHashFiles(ProjectPaths.CSV_PPDB_HUNG_SCORES_IDXS_PARTS_ARG_TEST,
				 ProjectPaths.PPDB_HUNG_FEATURE_PARTS_ARG_TEST);
	...
	private static void generateHungarianPPDBFeaturesAndSave(HashMap<Integer, Map<Integer, String>> summIdBoyMap,
		...
		header[11 + 2] = "mid_ppdb_hung_score_with_idexes";
		header[12 + 2] = "midSent_ppdb_hung_score_with_idexes";
		header[13 + 2] = "midSent_ppdb_hung_score_with_idexes";
		entries.add(header);
