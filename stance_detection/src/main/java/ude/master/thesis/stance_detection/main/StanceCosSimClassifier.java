...
public class StanceCosSimClassifier {
	...
	public static void main(String[] args) throws IOException {
		...
		classifier.setUseCosineSimilarity(true);
		System.out.println(classifier.isUseCosineSimilarity());
		classifier.initialize();
		
		classifier.train(true, "libsvm_CosSim_features_");
		classifier.evaluateOnTestset("libsvm_CosSim_features_");
		classifier.saveInstancesToArff("CosSim_features_" + getCurrentTimeStamp());
